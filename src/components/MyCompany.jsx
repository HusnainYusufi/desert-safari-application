...
export default function MyCompany({ initial, onSave, onCancel }) {
  const [form, setForm] = useState(initial ?? { name:"Legend Delivery", phone:"+971 55 555 5555", address:"Dubai, UAE", logo:null });
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center gap-4 mb-4">
            <div className="h-20 w-20 rounded-full bg-slate-200 dark:bg-slate-800 overflow-hidden flex items-center justify-center">
