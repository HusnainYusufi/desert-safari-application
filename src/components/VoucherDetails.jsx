...
const QR = () => <div className="h-32 w-32 bg-slate-200 grid place-items-center rounded"><span className="text-xs text-slate-500">QR</span></div>;
      ...
      <div className="card p-4">
        ...
        <div className="mt-4 flex items-center gap-4">
          ...
          <div className="space-y-2">
            ...
            <Button variant="outline" onClick={onShareEmail}>Share via Email</Button>
            <Button variant="outline" onClick={onRegeneratePdf}>Regenerate PDF</Button>
          </div>
        </div>
        <div className="mt-4">
          <Button variant="outline" onClick={onEdit}>Edit Voucher</Button>
        </div>
      </div>
    </div>
  );
